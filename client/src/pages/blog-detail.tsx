  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        {/* Header */}
        <section className="relative bg-gradient-primary text-white py-10 md:py-16 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-4 md:mb-6 leading-tight">
                {blog.title}
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-3 md:gap-6 text-sm opacity-80">
