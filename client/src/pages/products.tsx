      ...
      <table className="w-full border-collapse bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <tbody>
          ...
          <tr className="bg-gray-25">
            ...
            <td className="border border-gray-200 p-4 text-center">₹12,500 - ₹14,500</td>
          </tr>
          <tr>
...
export default function ProductsPage() {
  ...
  return (
    <>
      <SEOHead
        title="CCTV Camera Packages & Security Products | Silver, Gold & HD Series | Kirpal Securities"
        description="🎯 Complete CCTV camera packages in Jalandhar: Silver (₹10K-₹21K), Gold (₹14.5K-₹23K) & HD Series. 4-8 camera setups with 2-year warranty. Professional installation included. Get quote on WhatsApp!"
      ...
      <section className="bg-brand-red text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Professional surveillance packages with 2-year warranty. Complete setups including cameras, NVR/DVR, wiring, and professional installation in Hoshiarpur, Jalandhar.
          </p>
        </div>
      </section>
