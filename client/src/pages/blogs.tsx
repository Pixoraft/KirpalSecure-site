  ...
  return (
    <>
      <SEOHead
        ...
        image="https://kirpalsecurities.in/blog-security-insights.jpg"
        url="https://kirpalsecurities.in/blogs"
        type="website"
      />

      {/* Hero Section */}
      <section className="relative bg-gradient-primary text-white py-12 md:py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 md:mb-6 text-display">
              Security Insights
            </h1>
      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-modern p-4 md:p-8"
