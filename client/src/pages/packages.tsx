  ...
  return (
    <>
      <SEOHead
        ...
        image="https://kirpalsecurities.in/cctv-packages.jpg"
        url="https://kirpalsecurities.in/packages"
        type="website"
      />
      ...
      <section className="bg-brand-red text-white py-10 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">CCTV Camera Packages</h1>
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Compare Our CCTV Series</h2>
            <p className="text-base md:text-xl text-gray-600">Choose the perfect security solution for your needs</p>
          </div>
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Why Choose Our CCTV Packages?</h2>
            <p className="text-base md:text-xl text-gray-600">Professional security solutions with complete peace of mind</p>
          </div>
      ...
      <section className="py-10 md:py-16 bg-brand-red text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Ready to Secure Your Property?</h2>
          <p className="text-base md:text-xl mb-6 md:mb-8">Get instant quotes and professional consultation via WhatsApp.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button 
              ...
              className="bg-white text-brand-red hover:bg-gray-100 w-full sm:w-auto px-6 py-3"
