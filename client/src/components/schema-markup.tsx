...
export function SchemaMarkup({ 
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "@id": "https://kirpalsecurities.in/#organization",
    ...
    "image": "https://kirpalsecurities.in/kirpal-securities-team.jpg",
  ...
  const blogSchema = blogTitle ? {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://kirpalsecurities.in/blog/${blogTitle?.toLowerCase().replace(/\s+/g, '-')}`
    }
  } : null;
  ...
  const websiteSchema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://kirpalsecurities.in/search?q={search_term_string}",
